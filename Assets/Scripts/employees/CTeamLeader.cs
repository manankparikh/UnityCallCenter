...
using System.Text;
	...
	public class CTeamLeader : IEmployee
	{
		...
		{
			return EEmployeeDesignation.TeamLeader;
		}

		public EProblemID GetSupportedProblemIDs()
		{
			//Team Leader Employees Can Handle Any Caller Issue Except For 1
			return
				EProblemID.Level2 | EProblemID.Level3 | EProblemID.Level4 | EProblemID.Level5 |
				EProblemID.Level6 | EProblemID.Level7 | EProblemID.Level8 | EProblemID.Level9 |
				EProblemID.Level10 | EProblemID.Level11 | EProblemID.Level12;
		}
